/*
  # Fix database schema and policies for proper category/goal persistence

  1. Schema Updates
    - Ensure proper TEXT type for user_id columns
    - Add proper foreign key constraints with CASCADE delete
    - Add missing indexes for better performance

  2. Security Updates
    - Recreate all RLS policies with correct user_id handling
    - Ensure proper access control for categories, goals, and motivations

  3. Data Integrity
    - Proper CASCADE delete relationships
    - Consistent user_id references across all tables
*/
