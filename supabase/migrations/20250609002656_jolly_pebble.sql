/*
  # Fix database schema and update user_id columns

  1. Schema Updates
    - Drop existing policies that depend on user_id columns
    - Update user_id column types to TEXT in categories and goals tables
  ...
  3. Security
    - Recreate RLS policies with proper authentication checks
